...
android {
  ...
  // `assembleRelease` still works on a clean checkout / CI runner without secrets
  // (it then falls back to the standard debug signing identity).
  ...
  buildTypes {
    release {
      isCrunchPngs = true
      // Shrink + optimise the release build: smaller APK and faster app startup.
